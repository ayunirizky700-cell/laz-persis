        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Menu untuk Super Admin & Admin/Amil --}}
                    @if(auth()->user()->isSuperAdmin() || auth()->user()->isAdminAmil())
                    ...
                    {{-- Menu Persetujuan: Super Admin & Pimpinan --}}
                    ...
                    {{--
                    Menu Users & Roles: Akan ditambahkan setelah Silpi selesai
