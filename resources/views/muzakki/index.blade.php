                ...
                <div class="p-6 text-gray-900 overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($muzakki as $index => $m)
                                <tr>
                                    <td class="px-4 py-2">{{ $muzakki->firstItem() + $index }}</td>
                                    <td class="px-4 py-2 font-mono text-sm">{{ $m->kode }}</td>
                                    <td class="px-4 py-2">{{ $m->nama }}</td>
                                    <td class="px-4 py-2">{{ $m->no_telepon }}</td>
                                    <td class="px-4 py-2 capitalize">{{ $m->kategori }}</td>
                                    <td class="px-4 py-2">
