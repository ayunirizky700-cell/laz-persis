<x-app-layout>
    ...
    <style>
        ...
        /* ================= WARNA IKON & ANGKA ================= */
        .icon-blue { background-color: #e6f0ff; color: #0d6efd; }
        .text-blue { color: #0d6efd; }

        .icon-red { background-color: #ffe6e6; color: #dc3545; }
        .text-red { color: #dc3545; }

        .icon-yellow { background-color: #fff8e1; color: #ffc107; }
        .text-yellow { color: #ffc107; }

        .icon-green { background-color: #e8f5e9; color: #198754; }
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="dashboard-container">
                ...
                <div class="welcome-banner">
                    <h1>Selamat Datang, Super Admin LAZ! 👋</h1>
                    <p>Anda login sebagai <strong>super_admin</strong></p>
